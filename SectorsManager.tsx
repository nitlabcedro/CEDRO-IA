...
export default function ReportView({ record, onBack, onEdit, isAdmin, workflows, approvalConfig }: ReportViewProps) {
  ...
  const getStatusBgColor = (rawStatus: StatusUso) => {
    ...
    switch (status) {
      ...
      case StatusUso.CANCELADA:
        return "bg-[#F29222]/10 text-[#9A4F00] border-[#F29222]/30";
  ...
  const getStatusMetadata = (rawStatus: StatusUso) => {
    ...
    switch (status) {
      ...
      case StatusUso.CANCELADA:
        return {
          label: "Cancelada pelo solicitante",
          sub: "A solicitação foi cancelada diretamente pelo solicitante.",
          color: "bg-[#F29222]/10 text-[#9A4F00] border-[#F29222]/30 shadow-[#F29222]/10",
          icon: <AlertTriangle className="w-5 h-5 text-[#9A4F00] shrink-0" />,
          dotColor: "bg-[#F29222]",
          glowColor: "shadow-[#F29222]/10"
        };
      case StatusUso.NAO_APROVADO:
      default:
        return {
  ...
  const getStatusColor = (rawStatus: StatusUso) => {
    ...
    switch (status) {
      ...
      case StatusUso.CANCELADA:
        return "bg-[#F29222]/10 text-[#9A4F00] border-[#F29222]/20 dot-bg-[#F29222]";
      case StatusUso.NAO_APROVADO:
      default:
  ...
  return (
    <div className="space-y-10 pb-24 w-full max-w-none px-0 bg-[#F6F8F5]/30">
      {/* 1. Cabeçalho da IA */}
