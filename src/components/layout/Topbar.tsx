...
import { Bell, UserCircle, ChevronDown, X, CheckCircle2, Eye, Check } from "lucide-react";
            ...
            <>
              ...
              <div className="absolute right-0 mt-3 w-80 sm:w-96 bg-white border border-[#E3E8E1] rounded-2xl shadow-xl z-50 text-[#1F2933] overflow-hidden animate-fade-in origin-top-right">
                ...
                <div className="max-h-96 overflow-y-auto custom-scrollbar divide-y divide-[#E3E8E1]/60">
                  {systemAlerts.filter(a => a.status !== "Resolvido").length === 0 ? (
                              ...
                              <div className="flex items-center gap-1 shrink-0">
                                {alert.status === "Ativo" && (
                                  <button
                                    ...
                                    className="text-[9px] font-extrabold text-[#075618] hover:bg-[#EAF4EC] px-2 py-1 rounded-md border border-[#BFD8C5]/50 transition-colors cursor-pointer"
                                ...
                                <button
                                  ...
                                  className="p-1 text-[#667085] hover:text-[#075618] hover:bg-[#EAF4EC] rounded-md transition-colors cursor-pointer"
                                  title="Resolver e ocultar"
                                >
                                  <Check size={14} />
                                </button>
                              </div>
