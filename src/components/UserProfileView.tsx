              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start mt-2">
                {(() => {
                  ...
                  return sectors.map((sec, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex items-center gap-1.5 px-3 py-1.5 bg-[#EAF4EC] border border-[#BFD8C5]/60 text-slate-800 rounded-xl text-xs font-bold shadow-3xs">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                {isNitMember && (
                  <div className="pt-4 border-t border-[#E3E8E1]">
                    <button
                      type="button"
                      disabled={loading}
                            ...
                            <div key={index} className="p-4 bg-[#F6F8F5] border border-[#E3E8E1] rounded-2xl space-y-3 relative shadow-3xs">
                              ...
                              <div className="relative">
                                <select
                                  ...
                                  className="w-full pl-4 pr-10 py-3 bg-white border border-[#E3E8E1] rounded-xl focus:border-[#075618] outline-none transition-all text-xs text-[#1F2933] font-bold appearance-none cursor-pointer shadow-3xs"
                                >
                              ...
                              <div className="relative">
                                <select
                                  ...
                                  className="w-full pl-4 pr-10 py-3 bg-white border border-[#E3E8E1] rounded-xl focus:border-[#075618] disabled:opacity-50 outline-none transition-all text-xs text-[#1F2933] font-bold appearance-none cursor-pointer shadow-3xs"
                                >
                                  <option value="">{combo.setor ? "Selecione o cargo..." : "Selecione o setor primeiro"}</option>
