        ...
        <div className="flex flex-col lg:flex-row gap-3 items-stretch lg:items-center justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                value={statusSelect}
                onChange={(e) => { setStatusSelect(e.target.value as any); setCurrentPage(1); }}
                className="bg-slate-50 border border-slate-200 rounded-xl text-xs py-2 px-3 outline-none text-slate-700 font-medium focus:border-[#03440c] transition-colors"
              >
