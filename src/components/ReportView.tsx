  ...
  const getStatusMetadata = (status: StatusUso) => {
    switch (status) {
      case StatusUso.APROVADO:
        return {
          label: "Aprovado",
          sub: "Registra conformidade total com as diretrizes de governança.",
    ...
    >
      ...
      <div style={{
        ...
        {[
          ...
          { label: "Risco", value: record.classificacaoRiscoManual || "Não avaliado" },
          ...
          <div className="space-y-6 animate-fade-in text-slate-800">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 bg-emerald-50/50 border border-emerald-100 rounded-3xl print:hidden">
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500 font-medium leading-normal max-w-xl">
                  Gere o PDF oficial do laudo técnico para arquivamento digital, envio por e-mail ou impressão física.
                </p>
              </div>
