            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <input 
                  ...
                  className="w-full pl-9 pr-8 py-1.5 bg-white border border-[#E3E8E1] rounded-xl text-xs text-[#1F2933] placeholder-[#667085] focus:outline-none focus:border-[#075618] focus:ring-1 focus:ring-[#075618] transition font-semibold"
                />
                {searchQuery && (
                  <button 
