                  ...
                  {!isAdmin ? (
                    (() => {
                      ...
                      if (sList.length > 1) {
                        return (
                          <CustomDropdown
                            placeholder="Selecione um dos seus setores..."
                  ...
                  {!isAdmin ? (
                    (() => {
                      ...
                      if (validCargosForCurrentSector.length > 1) {
                        return (
                          <CustomDropdown
                            placeholder="Selecione o cargo para este setor..."
                            value={formData.cargo || ""}
                            options={validCargosForCurrentSector}
                    ...
                    <CustomDropdown
                      placeholder="Selecione seu cargo / função..."
                      value={formData.cargo || ""}
