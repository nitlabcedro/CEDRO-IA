...
export default function Dashboard({ 
  ...
  const donutData = useMemo(() => {
    return [
      ...
      { name: "Canceladas", value: stats.canceladas, color: "#F29222" } // Warm yellow-orange warning tone
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 xl:col-span-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col justify-between">
          <div>
            ...
            {/* LEGENDS ROW */}
            <div className="grid grid-cols-4 gap-1.5 py-3 border-t border-slate-50">
